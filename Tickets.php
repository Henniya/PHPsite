...
<body>
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
      <main id="content">
        <input type="number" placeholder="klantID" min="1" name="klantid" required>
        <input type="number" placeholder="Aantal" min="1" name="aantal" required>
        <select name="kaartenType">
