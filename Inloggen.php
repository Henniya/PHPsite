...
<?php if (!empty($_POST["email"]) && !empty($_POST["password"])) {
    ...
    $query = mysqli_query($db, $sql); //stuurt de query samen met de connectie naar de database
    $result = mysqli_num_rows($query); //geeft een waarde van 0 of 1 weer

    if($result === 1) { //als het resultaat klopt dan gaat ie naar profile.php
...
<body>
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1>Inloggen</h1>
        <form action="private/action/inlogAction.php" method="post">
          <div class="form_settings">
            ...
            <p><span>Wachtwoord</span><input class="Wachtwoord" type="text" name="Wachtwoord" value="" /></p>
              geen account? <a href="registratie.php">registreer</a> dan nu</p>
